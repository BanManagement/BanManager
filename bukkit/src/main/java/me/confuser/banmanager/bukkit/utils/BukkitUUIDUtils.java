 ...
 */
public class BukkitUUIDUtils implements Callable<Map<String, UUID>> {//TODO abstract out for impl
    ...
    public BukkitUUIDUtils(List<String> names, boolean rateLimiting) {
        this.names = ImmutableList.copyOf(names);
        this.rateLimiting = rateLimiting;
    }

    public BukkitUUIDUtils(Set<String> names, boolean rateLimiting) {
        this.names = ImmutableList.copyOf(names);
        this.rateLimiting = rateLimiting;
    }

    public BukkitUUIDUtils(List<String> names) {
        this(names, true);
    }
    ...
    public Map<String, UUID> call() throws Exception {
        ...
        for (int i = 0; i < requests; i++) {
            ...
            for (Object profile : array) {
                ...
                UUID uuid = BukkitUUIDUtils.getUUID(id);

...
public class MuteIpCommand extends SingleCommand {

  public MuteIpCommand(LocaleManager locale) {
    super(CommandSpec.MUTEIP.localize(locale), "muteip", CommandPermission.MUTEIP, Predicates.alwaysFalse());
  }
  ...
  public CommandResult execute(BanManagerPlugin plugin, Sender sender, List<String> argsIn, String label) {
    ...
    plugin.getBootstrap().getScheduler().executeAsync(() -> {
      ...
      plugin.getBootstrap().getScheduler().executeSync(() -> {
        String message = Message.MUTEIP_IP_DISALLOWED.asString(plugin.getLocaleManager(),

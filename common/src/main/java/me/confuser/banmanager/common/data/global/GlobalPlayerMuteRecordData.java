...
public class GlobalPlayerMuteRecordData {
  ...
  GlobalPlayerMuteRecordData() {

  }

  public GlobalPlayerMuteRecordData(PlayerData player, PlayerData actor) {
  ...
  public GlobalPlayerMuteRecordData(PlayerData player, PlayerData actor, long created) {
    this(player, actor);

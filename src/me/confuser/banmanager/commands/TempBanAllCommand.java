...
public class TempBanAllCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command command, String commandLabel, String args[]) {
		...
		if (sender instanceof Player) {
			...
			if (!player.hasPermission("bm.tempbanall")) {
	...
	private void ban(CommandSender sender, String playerName, String playerDisplayName, String bannedByName, boolean online, String reason, String viewReason, Long timeExpires, String formatExpires) {
		...
		plugin.addExternalPlayerBan(playerName, bannedByName, reason, timeExpires);
		...
		Util.sendMessageWithPerm(message, "bm.notify.tempban");
	}
}
...
public class ExternalIpBanData {
  ...
  public ExternalIpBanData(long ip, PlayerData actor, String reason) {
    this.ip = ip;
    this.reason = reason;
  ...
  public ExternalIpBanData(long ip, PlayerData actor, String reason, long expires) {
  ...
  public ExternalIpBanData(long ip, PlayerData actor, String reason, long expires, long created) {

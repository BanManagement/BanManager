...
public class ExternalPlayerBanData {
  ...
  ExternalPlayerBanData() {

  }

  public ExternalPlayerBanData(PlayerData player, PlayerData actor, String reason) {
  ...
  public ExternalPlayerBanData(PlayerData player, PlayerData actor, String reason, long expires) {
  ...
  public ExternalPlayerBanData(PlayerData player, PlayerData actor, String reason, long expires, long created) {

...
public class ExternalPlayerMuteRecordData {
  ...
  ExternalPlayerMuteRecordData() {

  }

  public ExternalPlayerMuteRecordData(PlayerData player, PlayerData actor) {
  ...
  public ExternalPlayerMuteRecordData(PlayerData player, PlayerData actor, long created) {
    this(player, actor);

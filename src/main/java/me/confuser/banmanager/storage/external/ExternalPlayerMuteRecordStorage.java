...
public class ExternalPlayerMuteRecordStorage extends BaseDaoImpl<ExternalPlayerMuteRecordData, Integer> {
  ...
  public ExternalPlayerMuteRecordStorage(ConnectionSource connection) throws SQLException {
    super(connection, (DatabaseTableConfig<ExternalPlayerMuteRecordData>) BanManager.getPlugin().getConfiguration()
                                                                                    .getExternalDb()
